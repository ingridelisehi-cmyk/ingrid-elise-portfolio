...
export default async function ProjectDetailPage({params}: ProjectPageProps) {
  ...
  const project =
    ...
    fallbackProjectDetails[slug as keyof typeof fallbackProjectDetails] ??
    null;
    ...
    <article>
      ...
      {projectDetail.imageUrls?.length ? (
        <section
          className={
            isDigitalPassport
              ? "section project-detail-image-section"
              : "section grid cards-2"
          }
        >
          {projectDetail.imageUrls
            .slice(0, isDigitalPassport ? 1 : 4)
            .map((imageUrl) => (
              <Image
                key={imageUrl}
                src={imageUrl}
                ...
                className={
                  isDigitalPassport
                    ? "project-detail-image project-detail-image-hero"
        ...
        <section className="section press-feature reveal">
          <div className="card press-feature-card">
            ...
            <p className="press-copy">
              AGES by HS fikk redaksjonell omtale i Melk &amp; Honning, der
              Ingrid og medgründer Filippa Sekkelsten ble intervjuet om
              merkevaren, designfilosofien og bærekraftsarbeidet.
            </p>
            <a
